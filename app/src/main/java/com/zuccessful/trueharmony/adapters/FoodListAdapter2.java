...
public class FoodListAdapter2 extends RecyclerView.Adapter<FoodListAdapter2.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.food_content2, parent, false);
    ...
    public FoodListAdapter2(List<String> foodList) {
        this.foodList = foodList;
        selectedFood = new ArrayList<>();
    }

    @Override
    public void onBindViewHolder(@NonNull final FoodListAdapter2.MyViewHolder holder, int i) {
